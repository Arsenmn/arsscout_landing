...
export default function SalesPitchSection() {
  return (
    <section className="relative pb-16 lg:pb-24 overflow-hidden bg-linear-to-b from-slate-50 via-white to-gray-50">
      ...
      <div className="mx-auto px-6 lg:px-8 relative z-10 max-w-7xl">
        ...
        <div className="text-center mb-20 lg:mb-24 max-w-4xl mx-auto">
          <h2 className="text-5xl lg:text-6xl xl:text-7xl font-black bg-linear-to-r from-emerald-600 via-teal-600 to-emerald-500 bg-clip-text text-transparent mb-6 leading-tight">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 xl:gap-10 mb-20 lg:mb-24">
          ...
          <div className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-xl hover:shadow-slate-300/40 hover:border-slate-300/80 transition-all duration-700 ease-out hover:-translate-y-3 hover:scale-[1.01] overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-amber-50/60 to-yellow-100/40 opacity-0 group-hover:opacity-100 group-hover:animate-pulse blur-sm transition-all duration-1000 rounded-3xl" />
          ...
          <div className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-xl hover:shadow-slate-300/40 hover:border-slate-300/80 transition-all duration-700 ease-out hover:-translate-y-3 hover:scale-[1.01] overflow-hidden md:col-span-2 xl:col-span-1">
            <div className="absolute inset-0 bg-linear-to-br from-blue-50/60 to-indigo-50/40 opacity-0 group-hover:opacity-100 group-hover:animate-pulse blur-sm transition-all duration-1000 rounded-3xl" />
            <div className="relative flex flex-col items-center text-center h-full justify-center">
          ...
          {/* Benefit 3 */}
          <div className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 lg:p-10 shadow-lg hover:shadow-xl hover:shadow-slate-300/40 hover:border-slate-300/80 transition-all duration-700 ease-out hover:-translate-y-3 hover:scale-[1.01] overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-purple-50/60 to-violet-50/40 opacity-0 group-hover:opacity-100 group-hover:animate-pulse blur-sm transition-all duration-1000 rounded-3xl" />
            <div className="relative flex flex-col items-center text-center h-full justify-center">
          ...
          <div className="group relative bg-linear-to-br from-emerald-50/90 via-white to-teal-50/90 backdrop-blur-2xl border-2 border-emerald-200/70 rounded-3xl p-10 lg:p-12 shadow-xl hover:shadow-2xl hover:shadow-emerald-300/40 hover:border-emerald-300/90 transition-all duration-700 ease-out hover:scale-[1.02] overflow-hidden">
            ...
            <div className="relative flex flex-col items-center text-center h-full justify-center space-y-6">
              ...
              <button className="px-10 py-4 bg-linear-to-r from-emerald-500/95 to-teal-500/95 text-white font-black text-lg rounded-2xl shadow-xl hover:shadow-emerald-500/60 hover:scale-105 transition-all duration-300 border border-emerald-400/50 backdrop-blur-sm">
                Подключить сервис
              </button>
            </div>
          </div>
