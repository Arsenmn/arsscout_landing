...
export default function Sellers() {
  ...
  return (
    <>
      ...
      <section className="py-24 px-3 bg-linear-to-br from-slate-900 via-slate-950 to-slate-900 text-slate-50 overflow-hidden">
                  ...
                  <div key={index} className="min-w-full px-6 lg:px-8">
                    <div className="bg-slate-900/60 backdrop-blur-xl rounded-3xl shadow-2xl shadow-slate-900/50 border border-slate-600/20 h-[380px] lg:h-[420px] flex flex-col p-8 lg:p-10">
                      ...
                      <div className="flex items-center justify-between pt-6 border-t border-slate-600/30 mt-auto">
                        ...
                        <button className="px-6 py-3 lg:px-8 lg:py-3.5 rounded-xl bg-linear-to-r from-teal-500/70 to-emerald-400/70 text-slate-900 font-semibold shadow-md hover:shadow-blue-500/50 transition-all duration-300 whitespace-nowrap text-sm lg:text-base">
                          Читать отзыв
                        </button>
                      </div>
                    </div>
