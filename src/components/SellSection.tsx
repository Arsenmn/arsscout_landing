      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 items-center gap-12 lg:gap-24 mb-24 lg:mb-32">
          ...
          <div className="lg:order-2 space-y-8 lg:max-w-lg">
            <div className="inline-flex items-center gap-4 px-6 py-3 rounded-2xl bg-emerald-50/80 border border-emerald-200/50 backdrop-blur-xl shadow-lg shadow-emerald-100/50">
              ...
              <span className="text-slate-700 font-semibold text-sm uppercase tracking-wider">Антидемпинг бот</span>
            </div>
            ...
            <h2 className="text-5xl lg:text-7xl font-black bg-gradient-to-r from-slate-900 via-slate-700 to-emerald-600/90 bg-clip-text text-transparent leading-tight">
              Демпингеры крадут<br/>ваши заказы?<br/><span className="text-emerald-600">Мы их обходим</span>
            </h2>
            ...
            <div className="bg-white/80 backdrop-blur-2xl rounded-4xl p-12 lg:p-16 border border-slate-200/50 shadow-2xl shadow-slate-200/50">
              <div className="grid grid-cols-2 gap-6 mb-8">
                <div className="bg-amber-50/50 rounded-2xl p-6 text-center border border-amber-200/50 hover:bg-amber-100/70 transition-colors shadow-sm hover:shadow-amber-200/50">
                  <div className="text-3xl mb-2 flex justify-center text-amber-500"><Zap className="w-8 h-8" /></div>
                  <div className="text-slate-900 font-bold text-xl">3 мин</div>
                  <div className="text-slate-600 text-sm uppercase tracking-wider">скорость реакции</div>
                </div>
                <div className="bg-red-50/50 rounded-2xl p-6 text-center border border-red-200/50 hover:bg-red-100/70 transition-colors shadow-sm hover:shadow-red-200/50">
                  <div className="text-3xl mb-2 flex justify-center text-red-500"><TabletSmartphone className="w-8 h-8" /></div>
                  <div className="text-slate-900 font-bold text-xl">Kaspi</div>
                  <div className="text-slate-600 text-sm uppercase tracking-wider">#1 автоматически</div>
                </div>
              </div>
              <div className="w-full h-48 lg:h-64 bg-gradient-to-br from-emerald-500/10 to-green-500/5 rounded-3xl border-2 border-emerald-200/50 backdrop-blur-xl flex items-center justify-center shadow-xl relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 text-xs text-emerald-600 font-bold tracking-wider">+350%</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex overflow-x-auto pb-8 lg:pb-0 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-slate-300/50 scrollbar-track-slate-100/50 lg:grid lg:grid-cols-3 lg:gap-8 lg:overflow-visible">
            {featureSpecs.map((feature, i) => (
              <div key={i} className="flex-none w-80 lg:w-auto snap-center px-4 lg:px-0 lg:flex-1 min-w-0">
                <div className="group h-full bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 hover:bg-white hover:border-emerald-300/70 shadow-lg hover:shadow-2xl hover:shadow-emerald-200/30 transition-all duration-500 hover:-translate-y-2 lg:hover:translate-y-0">
                  <div className="flex flex-col h-full">
                    <div className={`text-5xl mb-6 group-hover:scale-110 transition-transform duration-300 ${feature.baseColor} ${feature.hoverColor}`}>
                      {feature.icon}
                    </div>
                    <h4 className="text-2xl font-bold text-slate-900 mb-4">{feature.title}</h4>
                    <p className="text-slate-700 leading-relaxed flex-1">{feature.desc}</p>
                    <div className="mt-auto pt-6">
                      <span className={`inline-flex items-center gap-2 text-slate-600 ${feature.hoverColor} text-sm font-semibold group-hover:translate-x-2 transition-all duration-300`}>
                        Подробнее →
                      </span>
                    </div>
                  </div>
        ...
        <div className="mt-20 lg:mt-32 bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl shadow-slate-200/50">
          <div className="flex flex-wrap items-center gap-8 text-slate-700 font-semibold text-lg">
            <span className="flex items-center gap-2"><Rocket className="w-5 h-5 text-emerald-600" /> 500+ продавцов</span>
            <span className="text-slate-400">•</span>
            <span className="flex items-center gap-2"><ChartColumnBig className="w-5 h-5 text-emerald-600" /> +350% заказов</span>
            <span className="text-slate-400">•</span>
            <span className="flex items-center gap-2"><Zap className="w-5 h-5 text-amber-500" /> 3 мин реакция</span>
          </div>
          <button className="px-10 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white rounded-2xl shadow-lg hover:shadow-emerald-500/50 transition-all duration-300 font-bold text-lg">
